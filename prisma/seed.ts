...
async function main() {
  ...
  const event = await prisma.event.create({
    data: {
      ...
      tagline: "Gemeinsam die nächste Vertriebsphase gestalten",
      description:
        "Geschlossene Vertriebskonferenz für eingeladene Gäste mit Fokus auf Strategie, Marktimpulse und operative Zusammenarbeit.",
      ...
      pwaEnabled: true,
      confirmationText:
        "Vielen Dank für Ihre Registrierung. Ihre Agenda, Anreise und alle neuen Hinweise stehen jetzt im Teilnehmerbereich bereit.",
  ...
  const speakers = await Promise.all([
    ...
    prisma.speaker.create({
      data: {
        ...
        company: "Musterunternehmen GmbH",
        bio: "Matthias Reuter fokussiert sich auf Marktpotenziale, neue Partnerschaften und skalierbare Vertriebshebel für komplexe Energielösungen.",
    ...
    prisma.speaker.create({
      data: {
        ...
        company: "Musterunternehmen GmbH",
        bio: "Jonas Dietrich verantwortet Enablement-Programme, Best Practices und operative Tools für leistungsstarke Vertriebsteams.",
  ...
  const sessionData = [
    {
      ...
      description: "Management-Update zu Marktumfeld, Prioritäten und Wachstumspfaden im Vertrieb.",
      category: "Keynote",
    ...
    },
    {
      ...
      subtitle: "Go-to-market für komplexe Lösungen",
      description: "Praxisnahe Impulse für Angebotsentwicklung, Account Priorisierung und Abschlussstärke.",
      category: "Breakout",
      tags: ["B2B", "Industrie"],
    ...
    },
    {
      ...
      description: "Workshop zu praktischen Hilfsmitteln für eine konsistente Vertriebssteuerung im Alltag.",
      category: "Workshop",
    ...
    },
    {
      ...
      description: "Daten, Pipeline-Entwicklung und Handlungsempfehlungen für die nächsten Monate.",
      category: "Plenum",
      tags: ["Daten", "Forecast"],
    ...
    },
    {
      ...
      description: "Kurzformate aus den Regionen mit sofort übertragbaren Ideen für Vertrieb und Stakeholder-Kommunikation.",
      category: "Panel",
  ...
  await prisma.announcement.createMany({
    data: [
      ...
      {
        eventId: event.id,
        title: "Speaker Briefing verfügbar",
      ...
      },
      {
        ...
        body: "Business Casual für das Abendprogramm im Phoenix Areal.",
        audience: "registered",
        pinned: false,
  ...
  await prisma.venueInfo.createMany({
    data: [
      ...
      },
      {
        ...
        key: "parking",
        title: "Parken",
        content: "Kostenfreie Parkplätze P4 und P5 stehen für Konferenzgäste zur Verfügung.",
        sortOrder: 2,
      },
      {
        eventId: event.id,
        key: "shuttle",
        title: "Shuttle",
        content: "Shuttle-Service zwischen Hotel und Veranstaltungsort alle 30 Minuten von 07:30 bis 22:30 Uhr.",
        sortOrder: 3,
      },
      {
        eventId: event.id,
        key: "hotel",
        title: "Hotel",
        content: "Kontingent im Radisson Blu Dortmund mit individuellem Check-in Code für registrierte Teilnehmende.",
        sortOrder: 4,
      },
      {
        eventId: event.id,
        key: "wifi",
        title: "WLAN",
        content: "SSID: ConferenceCompanion-Guest | Passwort: Companion2026",
        sortOrder: 5,
      },
      {
        eventId: event.id,
  ...
  await prisma.faqItem.createMany({
    data: [
      {
        eventId: event.id,
        question: "Wann schließt die Registrierung?",
        answer: "Die digitale Registrierung bleibt bis einschließlich 12. Mai 2026 geöffnet.",
        sortOrder: 1,
      },
      {
        eventId: event.id,
        question: "Kann ich meine Session-Auswahl später ändern?",
      ...
      },
      {
        ...
        answer: "Ihr Hotelbedarf wird über die Registrierung erfasst. Details folgen in der Bestätigungs-E-Mail.",
        sortOrder: 3,
      },
    ],
  });
  ...
  for (let index = 0; index < 50; index += 1) {
    ...
    const attendee = await prisma.attendee.create({
      data: {
        ...
        accessibilityNeeds: index % 11 === 0 ? "Barrierefreier Zugang benötigt" : null,
        hotelRequired: index % 4 === 0,
        arrivalInfo: index < 32 ? "Anreise per Bahn am Vorabend" : null,
        departureInfo: index < 32 ? "Rückreise am 15. Mai ab 17:30 Uhr" : null,
    ...
    data: [
      {
        ...
        comment: "Sehr klarer Ablauf und starke inhaltliche Impulse für den Vertrieb.",
      },
      {
        eventId: event.id,
        attendeeId: sampleAttendee.id,
